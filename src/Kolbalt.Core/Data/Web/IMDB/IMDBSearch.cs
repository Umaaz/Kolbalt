...
namespace Kolbalt.Core.Data.Web.IMDB
{
    public class IMDBSearch
    {
        ...
        {
            return Regex.IsMatch(source, @"(Enter a word or phrase to search on|no matches|no exact matches)", RegexOptions.IgnoreCase) ? null : SearchIMDBBySource(source)[0];
        }
